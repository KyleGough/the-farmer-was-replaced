...
| [Carrots](polyculture/carrot_polyculture.py)         | `5m 27s`  | `79`  |
| [Wood](polyculture/tree_polyculture.py)              | `5m 52s`  | `88`  |
...
| <img width="400" height="225" alt="Hay" src="https://github.com/user-attachments/assets/2c3b01b9-efd0-448f-a80e-c9ff9d1b4131" /> | **`Hay Polyculture`** <br> Improves upon the generic polyculture script by preplanting bushes and replanting hay once if the companion is not a bush. Hay is harvested in a 2x2 area. |
| <img width="400" height="225" alt="Maze" src="https://github.com/user-attachments/assets/fd621219-b85e-4b27-84e3-ba6e86c76d28" /> | **`Maze`** <br> Drones solve multiple 8×8 and 4×4 mazes in parallel. Each maze and drone pair first runs a wall-hugging algorithm to build an adjacency graph. Then a BFS is run repeatedly to find the shortest path to the treasure. Adjacency graphs are updated periodically when new shortcuts are discovered.
| <img width="400" height="225" alt="Pumpkins" src="https://github.com/user-attachments/assets/6af5f08c-de8f-42fc-a132-443903634d85" /> | **`Pumpkins`** <br> Pairs of drones solve small pumpkin grids in parallel. Drones partition their area equally and record immature or dead pumpkin tiles. These are replanted until all tiles are grown. |
